package com.sapient.feescalculator.modal;

import java.util.Comparator;
import java.util.Date;

/*
 * This class is maintain the transaction details.
 */
public class Transaction implements Comparator<Transaction> {
	...
	public static class Builder {
		...
		public Builder marketValue(Double marketValue) {
			this.marketValue = marketValue;
			return this;
		}
		...
		public Builder transactionFees(Double transactionFees) {
			this.transactionFees = transactionFees;
			return this;
		}

		public Transaction build() {
			Transaction dto = new Transaction(this);
			return dto;
		}
	}
